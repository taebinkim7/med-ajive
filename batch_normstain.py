...
if __name__=='__main__':    
    ...
    parser.add_argument('--input_path', type=str, default='/pine/scr/y/a/yaoli/data/cbcs/raw_images', help='RGB image file')
    parser.add_argument('--output_path', type=str, default='/pine/scr/y/a/yaoli/data/cbcs/processed_images', help='save file')
